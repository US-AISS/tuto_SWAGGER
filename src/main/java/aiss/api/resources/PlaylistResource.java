...
public class PlaylistResource {
	...
	public Collection<Playlist> getAll(@QueryParam("order") String order, @QueryParam("isEmpty") Boolean isEmpty, @QueryParam("name") String name) 
	{
		...
		if (order != null) {
			if (order.equals("name")) {
				Collections.sort(result,Comparator.comparing(Playlist::getName));
			} else if (order.equals("-name")) {
				Collections.sort(result, Comparator.comparing(Playlist::getName).reversed());
			} else {
